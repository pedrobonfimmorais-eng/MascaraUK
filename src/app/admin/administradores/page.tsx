...
export const metadata: Metadata = { title: ta("admin.administrators.title") };
...
export default async function AdminAdministratorsPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <h1 className="text-2xl font-bold text-brand-secondary">{ta("admin.administrators.title")}</h1>
      <AdminInviteForm />
